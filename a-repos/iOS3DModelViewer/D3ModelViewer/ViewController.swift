...
class ViewController: UIViewController, UIGestureRecognizerDelegate, SCNSceneRendererDelegate {
    ...
    func show3DModel(name: String) {
        // Setup Scene
        scene = SCNScene(named: name)!
//        scene.lightingEnvironment.contents = lightingEnvironmentContent
//        scene.lightingEnvironment.intensity = lightingEnvironmentIntensity
        // Setup Camera
